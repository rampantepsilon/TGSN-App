...
//Information
function title() {
  var title = 'TGSN Staff HQ v3.0.4';
  return title;
}
function buildNum() {
  var build = '25.12.10';
...
const changelogOptions = {
  ...
  buttons: ['Close'],
  title: 'Changelog',
  message: 'Changes in TGSN Staff HQ v3.0.4',
  detail: `
  - Added Ability to change TGSNBot timed messages
  - Rearranged Link layout
  - Removed Schedule Editor & Message Board
