function loginInit(){
  ...
  if (sUser){
    document.getElementById('uNameStatic').innerHTML = `<span style='font-size: 24px'>` + sUser + `</span><br>` + sPosition;
    ...
    document.getElementById('userPic').innerHTML = `<img src='` + sLogo + `' width='60' height='60' style='border-radius: 50% 50% 50% 50%;'>`
  } else {
